...
export const githubTriageServer = (origin: string): ServerBinding[] => [
  ...
  },
  {
    ...
    prompts: createTicketPrompts(featureAgent.instructions, {
  ...
  },
  {
    ...
    prompts: createTicketPrompts(bugfixAgent.instructions, {
      renderTool: 'render_ticket_result',
      kind: 'bug',
    }),
    allowedTools: ['mcp__github__render_ticket_result'],
  },
  {
    ...
    prompts: createTicketPrompts(replyDraftAgent.instructions, {
